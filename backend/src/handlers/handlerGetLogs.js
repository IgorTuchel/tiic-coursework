/**
 * @file handlerGetLogs.js
 * @description Handler for retrieving error logs.
 * @module handlers/handlerGetLogs.js
 */
...
/**
 * Retrieves error logs based on the provided query parameters.
 * @async
 * @function handlerGetErrorLogs
...
export async function handlerGetErrorLogs(req, res) {
    ...
    if (req.query.from || req.query.to) {
        ...
        if (req.query.from && isValidDate(req.query.from)) {
            where.timestamp[Op.gte] = new Date(
