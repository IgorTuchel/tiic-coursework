    ...
    <header className="border-b border-slate-800 bg-slate-900 sticky top-0 z-50">
      <div className="px-4 sm:px-6 py-4 flex items-center justify-between">
        <Link
          ...
          aria-label="Inspectra Dashboard Home">
          <svg
            aria-hidden="true"
            width="28"
            height="28"
        ...
        <div className="hidden sm:flex items-center gap-8">
          <nav
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                isActive
                  ? "text-white font-semibold border-b-2 border-sky-500 pb-1"
          ...
          <div className="flex items-center gap-4 border-l border-slate-700 pl-6">
            ...
            <button
              ...
              <span
                aria-hidden="true"
                className="text-lg font-serif leading-none mt-0.5">
                Aa
              </span>
            ...
            <span
              className="text-xs text-slate-400 max-w-[120px] truncate"
              title={username}
        ...
        <div className="sm:hidden px-4 pb-4 flex flex-col gap-3 text-sm border-t border-slate-800 pt-3 bg-slate-900 shadow-lg">
          <nav aria-label="Mobile Navigation" className="flex flex-col gap-3">
            <NavLink
              ...
              className="text-slate-300 py-2 hover:text-white transition-colors block">
              Dashboard
            </NavLink>
            <NavLink
              to="/ar"
